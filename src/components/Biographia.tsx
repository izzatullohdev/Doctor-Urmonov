        ...
        {isAboutPage ? (
          <>
            ...
            <p className="text-[16px] sm:text-[18px] md:text-[20px] font-medium font-montserrat leading-[140%] text-[#454745]">
              опытный хирург с более чем 13-летней практикой в хирургии. Он всегда берется за сложные задачи. Свою карьеру начал в ведущем медицинском учреждении, где быстро зарекомендовал себя как надёжный специалист. Его учителя: академик, проф. Чойнзонов Е.Ц., академик, проф. Зикиряходжаев Д.З., проф. Афанасьев С.Г., проф. Хакимов Г.А., проф. Тузиков С.А., проф. Юлдошев Р.З., д.м.н. Добродеев А.Ю., к.м.н. Волков М.Ю.
            </p>
          </>
        ) : (
          <>
