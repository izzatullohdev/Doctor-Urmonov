    ...
    <>
      <section className="bg-[#F8F9FF] text-gray-900 px-4 md:px-10 py-10">
          ...
          <div className="w-[65%] max-md:w-full h-[340px] rounded-[14px] overflow-hidden">
            {contact?.map_embed && (
              <iframe
                ...
                src={getMapSrc(contact.map_embed) || ""}
                allowFullScreen
                loading="lazy"
                style={{ border: 0 }}
        ...
        <footer className="max-w-7xl mx-auto grid md:grid-cols-4 gap-8 text-sm">
          <div>
            <h1 title="Doctor Urmonov" className="text-[46px] font-poppins font-bold leading-[102%] mb-4">
              Doctor Urmonov
            </h1>
            <div className="flex items-center gap-3">
              ...
              <a href={social?.whatsaap} target="_blank">
          ...
          <div className="text-[#0A0933] font-montserrat">
            <h4 title={t('footer.menu')} className="text-[16px] font-bold mb-4">{t('footer.menu')}</h4>
          ...
          <div className="text-[#0A0933] font-montserrat">
            <h4 title={t('footer.address.address')} className="text-[16px] font-bold mb-4">{t('footer.address.address')}</h4>
            <p className="mb-2">
            ...
            <div className="flex items-center gap-5 mt-4">
              <div className="flex items-center gap-3">
                <FiPhoneCall size={18} />
                <p className="font-montserrat text-[#0A0933] flex flex-col items-start text-[10px] leading-[14px]">
                  <span className="font-bold">{t('global_title.phone')}</span>
                  {contact?.phone}
                </p>
              </div>
