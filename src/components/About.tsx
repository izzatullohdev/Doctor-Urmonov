    ...
    <div className='bg-[#F5F8FF] mt-[300px] max-lg:mt-[185px] my-20 max-xl:px-4 max-sm:px-0'>
        <div className="max-w-7xl mx-auto max-md:px-4 max-sm:px-0 flex items-center justify-between relative pt-12 pb-18">
            <div className="w-[58%]">
                ...
                <button className='bg-[#0A6CFB] rounded-[5px] text-[20px] max-md:text-[15px] max-sm:text-[10px] font-montserrat font-medium relative z-20 text-white px-8 py-5 mt-3'>Записаться на приём</button>
            </div>
            <img 
              src={bg} 
              loading="lazy"
