import { CardTypes, ServiceTypes, PatientTypes, InfoTypes } from '../src/types';
...
export const InfoData: InfoTypes[] = [
    ...
    {
        id: 2,
        title: "Какие документы нужны для записи?",
